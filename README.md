...
This is official notice that this project is no longer being monitored or maintained by the developers. Any PR that is submitted by sit unmerged for eternity. Lastly, the domain `scorestack [dot] io` is no longer affiliated with this project. 
