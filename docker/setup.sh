...
curl -k -XPOST -u elastic:${elastic_pass} 'https://localhost:9200/_security/role/dynamicbeat-role' -H "Content-Type: application/json" -d '{"indices":[{"names":["check*","attrib*"],"privileges":["read"]}],"run_as":["dynamicbeat"]}'
